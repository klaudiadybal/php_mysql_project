...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `harmonogramy` (id_kursu, id_nauczyciela, id_grupy, data, godzina_rozpoczęcia, godzina_zakończenia, typ, adres, sala)
    ...
    <div class="container my-5">
        <form method="post">
            ...
            <div class="mb-3">
                ...
                <input type="time" class="form-control" name="godzina_rozpoczecia">
            </div>

            <div class="mb-3">
                <label class="form-label">Godzina zakończenia:</label>
                <input type="time" class="form-control" name="godzina_zakonczenia">
            </div>
            <div class="mb-3">
                <label class="form-label">Typ:</label>
                <input type="text" class="form-control" placeholder="Podaj typ" name="typ">
            </div>
            <div class="mb-3">
                <label class="form-label">Adres:</label>
                <input type="text" class="form-control" placeholder="Podaj adres" name="adres">
            </div>

            <div class="mb-3">
                <label class="form-label">Sala:</label>
                <input type="text" class="form-control" placeholder="Podaj salę" name="sala">
            </div>
